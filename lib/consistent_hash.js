 ...
 */
ConsistentHash.prototype.addData = function addData(vnode, data) {
    var self = this;
    var log = self.log;
    log.info({
        vnodes: vnode,
...
ConsistentHash.prototype.getNode = function getNode(key) {
    var value = crypto.createHash(this.algorithm_.algorithm).update(key).digest('hex');
